...
function openHistoryModal(from, subject, message, response) {
    document.getElementById('historyModalTitle').innerText = 'Historial: ' + subject;

    // Formatear el mensaje con negritas y separador
    document.getElementById('historyModalBody').innerHTML = '<strong>Mensaje:</strong> ' + message + '<hr>';

    // Formatear la respuesta con negritas
    document.getElementById('historyModalResponse').innerHTML = '<strong>Respuesta:</strong> ' + response;
